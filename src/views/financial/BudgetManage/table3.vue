<template>
  <div class="app-container calendar-list-container">
    ...
    <div class="itemBox" v-if="show">
      <el-row>
        <el-col :span="4">
          <span class="itemSpan1">订单号</span>
        </el-col>
        <el-col :span="4">
          <span class="itemSpan1">客户名称</span>
        </el-col>
        <el-col :span="4">
      ...
      <div :data="list" v-for="(item,index) in list" :key="index">
        <el-row>
          <el-col :span="4">
            <span class="itemSpan1">{{item.orderId}}</span>
          </el-col>
          <el-col :span="4">
            <span class="itemSpan1">{{item.customerName}}</span>
          </el-col>
          <el-col :span="4">
...
export default {
  ...
  methods: {
    ...
    Expjs(response) {
      ...
      downloadElement.download = nowDate + "-单票货物利润统计.xls"; // xxx.xls/xxx.xlsx

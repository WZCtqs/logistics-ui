        ...
        <el-card class="box-card">
          <el-form :label-position="labelPosition" label-width="80px" :model="form" ref="form">
            <el-form-item label="父级节点" prop="parentId">
              <el-input v-model="form.parentId" disabled="disabled" placeholder="请输入父级节点"></el-input>
            </el-form-item>
            <el-form-item label="父级公司">
              <el-input v-model="currentName" disabled="disabled" placeholder="请输入父级节点"></el-input>
            </el-form-item>

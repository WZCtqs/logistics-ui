...
export function fetchList(query) {
  return request({
    url: '/oilcard/rechargeExternal/page',
    method: 'get',
    params: query
  })
}
...
export function expObj(str) {
  return request({
    url: '/oilcard/rechargeExternal/export/' + str,
    method: 'post',
    responseType: 'blob',
    headers: {
...
export function getTruckOilCardObj(id) {
  return request({
    url: '/oilcard/oilCard/getTruckOilCard?plateNumber=' + id,
    method: 'get'
  })
}
